...
import Business_img from './image/Business.png';
...
function BusinessPage() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=us&category=business&pageSize=${pageSize}&apiKey=d2b27050f51b434b80dec292733e13b9`;
    ...
    return(
        <>
            <div className="main-content Business" style={{paddingTop: '60px'}}>
                <section className="intro text-white text-center" style={{paddingTop: '70px'}}>
                    <h1>Business News</h1>
                    <p className='w-50 mx-auto mt-5 text-dark' style={{fontStyle: 'italic'}}>
                    Business journalism is the part of journalism that tracks, records,
                    analyzes and interprets the business, economic and financial activities
                    and changes that take place in societies. Topics widely cover the entire
                    purview of all commercial activities related to the economy.
                    </p>
                    <img></img>
                </section>


                <section className='technology-all-post container mt-4 d-flex justify-content-between'>
