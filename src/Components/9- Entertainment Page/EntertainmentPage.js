...
function EntertainmentPage() {
    ...
    // Entertainmen Categoty
    const [showTecPost, setshowTecPost] = useState([]);
    //console.log(showTecPost);

    const [pageSize, setPageSize] = useState(20);

    const url = `https://newsapi.org/v2/top-headlines?country=us&category=entertainment&pageSize=${pageSize}&apiKey=d2b27050f51b434b80dec292733e13b9`;
    ...
    return(
        <>
            <div className="main-content Entertainmen" style={{paddingTop: '60px'}}>
                <section className="intro text-white text-center" style={{paddingTop: '70px'}}>
                    <h1>Entertainmen News</h1>
                    <p className='w-50 mx-auto mt-5' style={{fontStyle: 'italic'}}>
                    An entertainment news program focuses on news involving the entertainment
                    industry, including the world of film, television and music.
                    </p>
                    <img></img>
                </section>
