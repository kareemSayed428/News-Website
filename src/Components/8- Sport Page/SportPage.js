...
function SportPage() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=us&category=sport&pageSize=${pageSize}&apiKey=d2b27050f51b434b80dec292733e13b9`;
    ...
    return(
        <>
            <div className="main-content Sport" style={{paddingTop: '60px'}}>
                <section className="intro text-white text-center" style={{paddingTop: '70px'}}>
                    <h1>Sport News</h1>
                    <p className='w-50 mx-auto mt-5' style={{fontStyle: 'italic'}}>
                    The Sporting News is a website and former magazine publication owned by
                    Sporting News Holdings, which is a U.S.-based sports media company
                    formed in December 2020 by a private investor consortium.
                    It was originally established in 1886 as a print magazine.
                    </p>
                    <img></img>
                </section>
