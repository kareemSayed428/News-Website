...
import './styleHealth.css';
import newspaper_img from './../3- Home/image/newspaper.jpg';
//import Health_img from './image/Business.png';
...
function HealthPage() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=us&category=health&pageSize=${pageSize}&apiKey=d2b27050f51b434b80dec292733e13b9`;
    ...
    return(
        <>
            <div className="main-content Health" style={{paddingTop: '60px'}}>
                <section className="intro text-white text-center" style={{paddingTop: '70px'}}>
                    <h1 className='text-dark'>Health News</h1>
                    <p className='w-50 mx-auto mt-5 text-dark' style={{fontStyle: 'italic'}}>
                    Health News is a web-based project that rates the completeness, accuracy,
                    and balance of news stories that include claims about medical treatments,
